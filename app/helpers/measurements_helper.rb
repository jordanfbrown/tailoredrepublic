  ...
  def measurement_metadata
    {
      neck: {
        url: 'SborRZpbXs0',
        summary: 'This measurement will determine how your collar will fit.',
        steps: [
      ...
      chest: {
        url: 't88GRfoRMdw',
        summary: 'Stand straight with your arms comfortably at your side.',
        steps: [
      ...
      waist: {
        url: 'hFV-edpqyno',
        summary: 'This will be the circumference of your waistband. Make sure the waistline of your pants is just below the level where you would wear your dress pants (this may differ from where you wear shorts/sweats)',
        steps: [
      ...
      hips: {
        url: 'CE3_EoB0Q78',
        summary: 'This measurement wraps around the butt and hips.',
        steps: [
      ...
      arm_length: {
        url: 'xjbNuM8Gw3w',
        summary: 'Stand straight with your arms hanging naturally at your side',
        steps: [
      ...
      jacket_length: {
        url: 'IYdA7kHGqFQ',
        summary: 'Stand straight with your arms comfortably at your side and remain looking straight forward',
        steps: [
      ...
      crotch: {
        url: '8F1gGzlGu0U',
        summary: 'This measurement will determine the length of the seam running from your fly to the top of your butt.  The goal here is to make it tight enough to look like proper tailored pants, but not so tight as to cause a ball wedgie (seriously).',
        steps: [
      ...
      pant_length: {
        url: 'dY_4INxrSgM',
        summary: 'Make sure the waistline of your pants is at the level where you would wear your dress pants (this may differ from where you wear shorts/sweats)',
        steps: [
